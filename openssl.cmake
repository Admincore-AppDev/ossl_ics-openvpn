...
if (${ANDROID_ABI} STREQUAL "armeabi-v7a")
	set(crypto_srcs ${crypto_srcs}
		...
		crypto/modes/ghashv8-armx_32.S
...
elseif (${ANDROID_ABI} STREQUAL "arm64-v8a")
	set(crypto_srcs ${crypto_srcs}
		...
		crypto/modes/ghashv8-armx_64.S
...
target_compile_definitions(crypto PRIVATE -DL_ENDIAN -DOPENSSL_BUILDING_OPENSSL -DNDEBUG -DOPENSSL_USE_NODELETE -DOPENSSL_PIC)
target_compile_options(crypto PRIVATE -Wno-missing-field-initializers -Wno-unused-parameter -Wno-atomic-alignment -Wall -O3 -pthread -Wa,--noexecstack -Qunused-arguments -fPIC)
...
if (${ANDROID_ABI} STREQUAL "x86_64" OR ${ANDROID_ABI} STREQUAL "arm64-v8a")
	target_compile_definitions(crypto PRIVATE -DOPENSSLDIR="lib/ssl" -DENGINESDIR="lib/engines-3" -DMODULESDIR="lib/ossl-modules")
else ()
	target_compile_definitions(crypto PRIVATE -DOPENSSLDIR="lib64/ssl" -DENGINESDIR="lib64/engines-3" -DMODULESDIR="lib64/ossl-modules")
endif ()
...
target_compile_definitions(ssl PRIVATE -DL_ENDIAN -DOPENSSL_BUILDING_OPENSSL -DNDEBUG -DOPENSSL_USE_NODELETE -DOPENSSL_PIC)
target_compile_options(ssl PRIVATE -Wall -O3 -pthread -Wa,--noexecstack -Qunused-arguments -fPIC)
